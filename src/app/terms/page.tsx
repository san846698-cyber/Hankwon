...
const SECTIONS = [
  ...
  {
    title: "제2조 (서비스 내용)",
    body: "회사는 이용자의 답변을 바탕으로 자서전 형식의 글을 생성하고, 이를 PDF 또는 인쇄본 형태로 제공합니다. 서비스의 구체적인 내용과 가격은 결제 화면에 표시된 바에 따릅니다.",
  },
  {
    title: "제3조 (이용료)",
  ...
  {
    title: "제6조 (책임의 한계)",
    body: "회사는 이용자의 답변을 바탕으로 자서전을 생성하나, 생성된 글의 모든 표현이 이용자의 의도와 정확히 일치함을 보장하지 않습니다. 이용자는 결제 전 미리보기를 통해 톤과 방향성을 확인하실 수 있습니다.",
  },
  {
    title: "제7조 (이용자의 의무)",
