...
const FAQS = [
  ...
  {
    q: "얼마나 걸리나요?",
    a: "부모님과 함께 질문에 답하는 데 보통 한 시간에서 한 시간 반 정도예요. 한 번에 다 못 하셔도 답변은 자동 저장되니 챕터별로 나눠서 진행하셔도 됩니다.",
  },
  {
    q: "결제 후 책은 언제 받나요?",
  ...
  {
    q: "글은 어떻게 만들어지나요?",
    a: "부모님 답변을 바탕으로 한국어 회고록 톤에 맞춰 글을 엮습니다. 답변 내용을 임의로 꾸며내지 않고, 부모님 말씀을 자연스러운 회고록 문체로 정성껏 다듬어요.",
  },
  {
    q: "답변 내용은 어떻게 보호되나요?",
